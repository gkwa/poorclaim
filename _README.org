...
{'ProductName': 'Cumin Seed', 'StoreName': 'Central Co-op', 'Type': 'Cumin'}
{'ProductName': 'Allspice', 'StoreName': 'Central Co-op', 'Type': 'Allspice'}
{'ProductName': 'Herbs or super greens lettuce', 'StoreName': 'Central Co-op', 'Type': 'Lettuce'}
{'ProductName': 'Marjoram Leaves', 'StoreName': 'Central Co-op', 'Type': 'Marjoram Leaves'}
# ...truncated to 10 for brevity
#+end_example
...
Results:
#+begin_example
{'r': {'urls': ['https://www.food.com/recipe/easy-black-bean-soup-59796?ftab=reviews#activity-feed'], 'name': 'Easy Black Bean Soup'}, 'products': [{'name': 'Salt', 'type': 'Salt'}, {'name': 'Chicken Broth', 'type': 'Broth'}, {'name': 'Extra Virgin Olive Oil', 'type': 'Olive Oil'}, {'name': 'Black Beans', 'type': 'Black Beans'}, {'name': 'Black Pepper', 'type': 'Black Pepper'}, {'name': 'Onion', 'type': 'Onion'}, {'name': 'Red Onion', 'type': 'Red Onion'}, {'name': 'Garlic', 'type': 'Garlic'}, {'name': 'Cilantro', 'type': 'Cilantro'}]}
...
* this should fail, but it silently discards
