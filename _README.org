...
RETURN r.name as RecipeName, s.name AS Store, COLLECT(DISTINCT p.name) AS Ingredients;
#+end_example

Results:
#+begin_example
{'RecipeName': 'Vegan Thai Red Curry', 'Store': 'Madison Co-op', 'Ingredients': ['Cumin seeds', 'Coriander seeds', 'White Peppercorns']}
{'RecipeName': 'Vegan Thai Red Curry', 'Store': 'Safeway', 'Ingredients': ['Shallots', 'Cilantro roots', 'Lemongrass']}
{'RecipeName': 'Vegan Thai Red Curry', 'Store': "Trader Joe's", 'Ingredients': ['Garlic']}
{'RecipeName': 'Vegan Thai Red Curry', 'Store': 'Uwajimaya', 'Ingredients': ['Galangal']}
#+end_example
...
Results:
#+begin_example
{'RecipeName': 'Chicken Thai Red Curry', 'Store': 'Safeway', 'Ingredients': ['Full fat coconut milk', 'Light Brown Sugar', 'Ginger', 'Chicken Stock or Water', 'Lemongrass', 'Zucchini']}
{'RecipeName': 'Chicken Thai Red Curry', 'Store': "Trader Joe's", 'Ingredients': ['Onion', 'Red Bell Pepper', 'Garlic']}
{'RecipeName': 'Chicken Thai Red Curry', 'Store': 'Uwajimaya', 'Ingredients': ['Thai basil']}
{'RecipeName': 'Chicken Thai Red Curry', 'Store': 'Madison Co-op', 'Ingredients': ['Boneless Chicken Thighs']}
{'RecipeName': 'Chicken Thai Red Curry', 'Store': 'Hau Hau Market', 'Ingredients': ['Fish sauce']}
{'RecipeName': 'Chicken Thai Red Curry', 'Store': 'Whole Foods', 'Ingredients': ['Lemon Juice']}
{'RecipeName': 'Vegan Thai Red Curry', 'Store': 'Madison Co-op', 'Ingredients': ['Cumin seeds', 'Coriander seeds', 'White Peppercorns']}
{'RecipeName': 'Vegan Thai Red Curry', 'Store': 'Safeway', 'Ingredients': ['Shallots', 'Cilantro roots', 'Lemongrass']}
{'RecipeName': 'Vegan Thai Red Curry', 'Store': "Trader Joe's", 'Ingredients': ['Garlic']}
{'RecipeName': 'Vegan Thai Red Curry', 'Store': 'Uwajimaya', 'Ingredients': ['Galangal']}
...
{'RecipeName': 'Chicken Thai Red Curry', 'Store': 'Hau Hau Market', 'Ingredients': ['Fish sauce']}
{'RecipeName': 'Chicken Thai Red Curry', 'Store': 'Whole Foods', 'Ingredients': ['Lemon Juice']}
{'RecipeName': 'Pad Thai', 'Store': 'Hau Hau Market', 'Ingredients': ['Shrimp', 'Fish sauce', 'Garlic Chives', 'Mung Bean Sprouts', 'Rice Sticks', 'Thai-style Baked Tofu', 'Rice Stick Noodles', 'Pressed Tofu', 'Roasted Chili Flakes']}
{'RecipeName': 'Pad Thai', 'Store': 'PCC', 'Ingredients': ['Dry-Roasted Peanuts', 'Tamarind Paste', 'Sweet Paprika', 'Grounded Roasted Peanuts']}
{'RecipeName': 'Pad Thai', 'Store': "Trader Joe's", 'Ingredients': ['Garlic', 'Lime', 'Chicken', 'Eggs', 'Pressed Tofu']}
{'RecipeName': 'Pad Thai', 'Store': 'Safeway', 'Ingredients': ['Granulated Sugar', 'Dried Shrimp', 'Mung Bean Sprouts', 'Vegetable Oil', 'Shallots']}
{'RecipeName': 'Pad Thai', 'Store': 'Viet-Wah Asian Food Market', 'Ingredients': ['Banana Leaf']}
{'RecipeName': 'Pad Thai', 'Store': 'Whole Foods', 'Ingredients': ['Lime juice']}
{'RecipeName': 'Pad Thai', 'Store': "Lam's Seafood Asian Market", 'Ingredients': ['Dried Shrimp']}
{'RecipeName': 'Pad Thai', 'Store': 'M2M Mart', 'Ingredients': ['Chili Sauce', 'Mung Bean Sprouts']}
{'RecipeName': 'Pad Thai', 'Store': 'Spice SPC', 'Ingredients': ['Chili Sauce', 'Tamarind Liquid']}
{'RecipeName': 'Pad Thai', 'Store': 'Uwajimaya', 'Ingredients': ['Rice Wine Vinegar', 'Palm Sugar', 'Tamarind Liquid', 'Sweetened Radish']}
{'RecipeName': 'Pad Thai', 'Store': 'Thanh Son Tofu', 'Ingredients': ['Thai-style Baked Tofu']}
{'RecipeName': 'Phad Thai', 'Store': 'PCC', 'Ingredients': ['Roasted Unsalted Peanuts']}
{'RecipeName': 'Vegan Thai Red Curry', 'Store': 'Madison Co-op', 'Ingredients': ['Cumin seeds', 'Coriander seeds', 'White Peppercorns']}
{'RecipeName': 'Vegan Thai Red Curry', 'Store': 'Safeway', 'Ingredients': ['Shallots', 'Cilantro roots', 'Lemongrass']}
{'RecipeName': 'Vegan Thai Red Curry', 'Store': "Trader Joe's", 'Ingredients': ['Garlic']}
{'RecipeName': 'Vegan Thai Red Curry', 'Store': 'Uwajimaya', 'Ingredients': ['Galangal']}
{'RecipeName': 'The Best Green Curry', 'Store': "Trader Joe's", 'Ingredients': ['Garlic cloves', 'Lime']}
{'RecipeName': 'The Best Green Curry', 'Store': 'Uwajimaya', 'Ingredients': ['Thai basil', 'Kaffir lime leaves', 'Galangal', 'Thai Eggplant', 'Palm Sugar', 'Snow peas']}
{'RecipeName': 'The Best Green Curry', 'Store': 'Madison Co-op', 'Ingredients': ['White Peppercorns', 'Chicken Thighs', 'Cumin seeds', 'Coriander seeds']}
{'RecipeName': 'The Best Green Curry', 'Store': 'Hau Hau Market', 'Ingredients': ['Kaffir lime leaves', 'Fish sauce']}
{'RecipeName': 'The Best Green Curry', 'Store': 'Safeway', 'Ingredients': ['Serranos', 'Lemongrass', 'Shallots', 'Cilantro', 'Full fat coconut milk', 'Chicken stock']}
{'RecipeName': 'Thai Eggplant Recipe', 'Store': 'Madison Co-op', 'Ingredients': ['Coriander powder', 'Chili powder']}
{'RecipeName': 'Thai Eggplant Recipe', 'Store': "Trader Joe's", 'Ingredients': ['Red Bell Pepper', 'Onion', 'Garlic cloves']}
{'RecipeName': 'Thai Eggplant Recipe', 'Store': 'Whole Foods', 'Ingredients': ['Lime juice']}
{'RecipeName': 'Thai Eggplant Recipe', 'Store': 'QFC', 'Ingredients': ['Salt']}
{'RecipeName': 'Thai Eggplant Recipe', 'Store': 'Safeway', 'Ingredients': ['Ginger', 'Lemongrass', 'Full fat coconut milk', 'Coconut Oil', 'Chicken stock']}
{'RecipeName': 'Thai Eggplant Recipe', 'Store': 'Uwajimaya', 'Ingredients': ['Thai basil', 'Thai Eggplant', 'Thai chilies']}
{'RecipeName': 'Thai Eggplant Recipe', 'Store': 'PCC', 'Ingredients': ['Coconut Oil']}
{'RecipeName': 'Thai Eggplant Recipe', 'Store': "Lam's Seafood Asian Market", 'Ingredients': ['Thai chilies']}
{'RecipeName': 'Yellow Coconut Curry Chicken', 'Store': 'Madison Co-op', 'Ingredients': ['Yellow Curry Powder']}
{'RecipeName': 'Yellow Coconut Curry Chicken', 'Store': 'Safeway', 'Ingredients': ['Carrots', 'Russet Potatoes', 'Brown Sugar', 'Full fat coconut milk', 'Coconut Oil', 'Chicken Broth', 'Cilantro']}
{'RecipeName': 'Yellow Coconut Curry Chicken', 'Store': 'Whole Foods', 'Ingredients': ['Maesri Thai Red Curry Paste']}
{'RecipeName': 'Yellow Coconut Curry Chicken', 'Store': "Trader Joe's", 'Ingredients': ['Garlic', 'Yellow Onion']}
{'RecipeName': 'Yellow Coconut Curry Chicken', 'Store': 'QFC', 'Ingredients': ['Chicken Breast']}
{'RecipeName': 'Yellow Coconut Curry Chicken', 'Store': 'Uwajimaya', 'Ingredients': ['Rice']}
{'RecipeName': 'Yellow Coconut Curry Chicken', 'Store': 'PCC', 'Ingredients': ['Coconut Oil']}
{'RecipeName': 'Yellow Coconut Curry Chicken', 'Store': 'Hau Hau Market', 'Ingredients': ['Fish sauce']}
{'RecipeName': 'Yellow Curry with Chicken', 'Store': 'Madison Co-op', 'Ingredients': ['Curry Powder', 'Cumin seeds', 'Coriander seeds']}
{'RecipeName': 'Yellow Curry with Chicken', 'Store': "Trader Joe's", 'Ingredients': ['Chicken', 'Garlic']}
{'RecipeName': 'Yellow Curry with Chicken', 'Store': 'Safeway', 'Ingredients': ['Shallots', 'Potatoes', 'Full fat coconut milk', 'Ginger', 'Lemongrass', 'Yellow Curry Paste']}
{'RecipeName': 'Yellow Curry with Chicken', 'Store': 'Hau Hau Market', 'Ingredients': ['Fish sauce']}
{'RecipeName': 'Yellow Curry with Chicken', 'Store': 'M2M Mart', 'Ingredients': ['Yellow Curry Paste']}
{'RecipeName': 'Yellow Curry with Chicken', 'Store': 'Uwajimaya', 'Ingredients': ['Galangal']}
#+end_example
